...
class HomepageLoseweight extends StatelessWidget {
  const HomepageLoseweight({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // ใช้ Container เพื่อไล่เฉดสีพื้นหลังให้เข้ากับธีมหลัก
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0xFFE3F2FD), // ฟ้าอ่อนธีม WEhealth
              Colors.white,
            ],
          ),
        ),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // --- Today's Goal Card (ปรับ Gradient และความมน) ---
                Container(
                  width: double.infinity,
                ...
                // --- Streak Days Card (ดีไซน์ใหม่ให้ดู Modern) ---
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(Icons.bolt_rounded, color: Colors.orange, size: 30),
