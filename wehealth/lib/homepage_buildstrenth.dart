...
class HomepageBuildstrength extends StatelessWidget {
  const HomepageBuildstrength({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // ใช้ Container ครอบเพื่อทำพื้นหลัง Gradient ของทั้งหน้า
      body: Container(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            value,
            style: GoogleFonts.nunito(fontSize: 17, fontWeight: FontWeight.w800, color: Colors.black87),
          ),
        ],
      ),
    );
